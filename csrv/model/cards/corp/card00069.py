...
class YesCard00069(actions.Action):
...
class NoCard00069(actions.Action):
  DESCRIPTION = 'Do not do net damage'


class DecideCard00069(timing_phases.ActivateAbilityChoice):
  """Choose whether to use Card00069."""

  def __init__(self, game, player, next_phase):
    timing_phases.ActivateAbilityChoice.__init__(
        self, game, player,
        YesCard00069(game, player),
        NoCard00069(game, player),
        next_phase)


class Card00069(asset.Asset):
