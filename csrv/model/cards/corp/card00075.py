...
class Card00075Subroutine(subroutine.Subroutine):
  ...
  def resolve(self, response=None):
    self.card.log('Card00075 is watching...')
    self.card.watch_for_next_encounter()


class Card00075(ice.Ice):
  ...
  def __init__(self, game, player):
    ...
    self.subroutines = [
        Card00075Subroutine(game, player, card=self),
    ]
  ...
  def do_net_damage(self):
    self.log('Card00075 found unbroken subroutines')
