...
class YesCard00087(actions.Action):
...
class NoCard00087(actions.Action):
  DESCRIPTION = 'Do not give the runner tags'


class DecideCard00087(timing_phases.ActivateAbilityChoice):
  """Choose whether to use Card00087."""

  def __init__(self, game, player, advancements):
    timing_phases.ActivateAbilityChoice.__init__(
        self, game, player,
        YesCard00087(game, player, advancements),
        NoCard00087(game, player),
        None)


class Card00087(asset.Asset):
