...
class InstallCard00040(actions.InstallHardware):
...
class Card00040(hardware.Hardware):
  ...
  def build_actions(self):
    ...
    self.install_action = InstallCard00040(self.game, self.player, self)
