...
class Card01016Action(actions.Action):
...
class Card01016(resource.Resource):
  ...
  WHEN_INSTALLED_PROVIDES_CHOICES_FOR = {
      timing_phases.RunnerTurnBegin: 'card01016_actions',
  }

  def build_actions(self):
    resource.Resource.build_actions(self)
    self._card01016_action = Card01016Action(self.game, self.player, self)

  def card01016_actions(self):
    return [self._card01016_action]
